...
# 2. Добавить инструкцию, создающую вложенный цикл.
    ...
    for j in range(1, 4) :
        ...
        if i == 1 and j == 1 :
            ...
            continue
# инструкция continue просто дает возможность пропустить первую итерацию внутреннего цикла при первом
# проходе наружного цикла.
        ...
        if i == 2 and j == 1: # Выполнение задания 4 обязательное соблюдение отступов
            ...
            break
# инструкция break заставляет пропустить все три итерации внутреннего цикла на втором проходе наружного.
